...
*/
#ifndef TAG_JATTRIBUTE_H
#define TAG_JATTRIBUTE_H
 ...
 * "Tag" JAttribute
 */
class TagJAttribute : public JAttributeBase
{
public:
    TagJAttribute() = default;
    ~TagJAttribute() = default;
    ...
    int32_t getInnerJAttributeType() {return TAG_JATTRIBTE;};
};
